...
public struct BeginGame : NetworkMessage {
    public byte phase;
}
...
public class SETNetworkManager : NetworkManager
{
    ...
    IEnumerator DelaySendBegin()
    {
        ...
        NetworkServer.SendToAll(new BeginGame { phase = 0 });
        yield return new WaitForSeconds(5);
        NetworkServer.SendToAll(new BeginGame { phase = 1 });
    }
    ...
    public override void OnStartClient() {
        ...
        NetworkClient.RegisterHandler<BeginGame>(OnBeginGameSend, false);
    }

    private void OnBeginGameSend(BeginGame msg)
    {
